...
import OrgItem from '@app/component/org/listItem.js';

class OrgCollect extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    ...
    refresh() {
        ...
        collectAction.getOrgCollectList(params, res => {
    ...
    loadMore() {
        ...
        collectAction.getOrgCollectList(
            params,
            res => {
...
export default connect(
    state => ({
        collectData: state.collect.orgCollect.data,
        page: state.collect.orgCollect.page,
        hasNext: state.collect.orgCollect.next
    }),
    dispatch => ({
